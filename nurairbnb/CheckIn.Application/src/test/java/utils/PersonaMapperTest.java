...
public class PersonaMapperTest {
    ...
    @Test
    public void testFrom_WithNonNullInput_ShouldMapFieldsCorrectly() throws BusinessRuleValidationException {
    ...
    @Test
    public void testFrom_WithNullFieldsInInput_ShouldMapToEmptyStrings() throws BusinessRuleValidationException {
        Persona input = null;
        PersonaDto result = personaMapper.from(input);
        assertNotNull(result);
