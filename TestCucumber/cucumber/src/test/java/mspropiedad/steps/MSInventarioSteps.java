...
public class MSInventarioSteps {
    ...
    public void getItemValidData(@Transpose DataTable dataTable) throws IOException {
        ...
        Double precio = Double.valueOf(data.get(0).get("precio"));
        ...
        String jsonAsString = jsonTemplate(envConfig.getProperty("mspropiedad-item_request"), valuesToTemplate);
    ...
    public void getItemInvalidData(@Transpose DataTable dataTable) throws IOException {
        ...
        valuesToTemplate.put("estado", "");
        valuesToTemplate.put("precio", "");
    ...
    public void submitItemCreation() {
        ...
        Response response = request
                ...
                .when().post(envConfig.getProperty("mspropiedad-service_url")
                        + envConfig.getProperty("mspropiedad-item_api"));
